...
- **Chrome is the browser (the user, 2026-09-23).** Design, build and verify in Chrome only, through Chrome DevTools. No Safari or Firefox testing, no test frameworks, no downloaded browsers, no CI test matrices: that is weight without return here. Keep the tooling as light and modern as the work.
